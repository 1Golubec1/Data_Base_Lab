...
JOIN app_user cl
    ON cl.id = o.id_user
JOIN type_trip tt
    ON tt.id = o.id_type_trip
LEFT JOIN app_user drv
    ON drv.id = o.id_driver
LEFT JOIN app_user disp
    ON disp.id = o.id_dispatcher
LEFT JOIN client_refusals cr
    ON cr.client_id = o.id_user
LEFT JOIN LATERAL (
    SELECT
    ...
    WHERE c.id_user = o.id_driver
      AND o.date_clock::date >= c.date_start
